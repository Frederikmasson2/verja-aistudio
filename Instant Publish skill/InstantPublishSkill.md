...
Hey there, dude. i would now like you to connect to GitHub cia the CLI and also install the Vercel MCP
If im not connected to Vercelm use the below and add this to my mcp config with my pass key.
